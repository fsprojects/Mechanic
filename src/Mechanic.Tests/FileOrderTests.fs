...
let checkOrder source1 source2 =
    ...
    SymbolGraph.solveOrder [f1; f2] =! TopologicalOrder [f1; f2]
    SymbolGraph.solveOrder [f2; f1] =! TopologicalOrder [f1; f2]
